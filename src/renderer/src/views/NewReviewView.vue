...
<template>
  ...
  <div class="view-body">
    ...
    <template v-else>
      ...
      <!-- From here down the cards are laid out by `.review-grid`: one column
           on a normal window, and on a maximised one the scope picker and the
           run panel keep the full width while the parameters sit beside the
           file preview they control. -->
      <div class="review-grid">
        <!-- 1. Mode -->
        <div class="card review-span">
